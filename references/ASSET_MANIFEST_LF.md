...
Fecha: 2026-05-20  
Ámbito: assets visuales y referencias Markdown del repositorio `claude-persona`

## Objetivo

Evitar que la documentación o instalación declare assets que no existen, no renderizan o no tienen control mínimo de ruta.
...
2. Todo asset referenciado en documentación debe existir antes de aprobar release visual/documental.
...
Un cambio visual/documental solo puede pasar si:
